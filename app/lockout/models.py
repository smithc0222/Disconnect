...
class Lockout(db.Model):
    ...
    def __repr__(self):
        return 'Lockout: {} | Desc: {}'.format(self.lockout_number, self.lockout_description)
...
class Open_Table(db.Model):
    ...
    created_by_id=db.Column('created_by_id', db.Integer, db.ForeignKey('user.id'))
    ...
    def __repr__(self):
        return 'Open on: {} | Lockout Desc: {}'.format(self.date, self.lockout.lockout_description)
...
class Implemented_Table(db.Model):
    ...
    implemented_by_id=db.Column('implemented_by_id', db.Integer, db.ForeignKey('user.id'))
    ...
    def __repr__(self):
        return 'Implemented on: {} | Lockout Desc: {}'.format(self.date, self.lockout.lockout_description)
...
class Accepted_Table(db.Model):
    ...
    accepted_by_id=db.Column('accepted_by_id', db.Integer, db.ForeignKey('user.id'))
    ...
    def __repr__(self):
        return 'Accepted on: {} | Lockout Desc: {}'.format(self.date, self.lockout.lockout_description)
...
class Released_Table(db.Model):
    ...
    released_by_id=db.Column('released_by_id', db.Integer, db.ForeignKey('user.id'))
    ...
    def __repr__(self):
        return 'Released on: {} | Lockout Desc: {}'.format(self.date, self.lockout.lockout_description)
...
class Cleared_Table(db.Model):
    ...
    cleared_by_id=db.Column('cleared_by_id', db.Integer, db.ForeignKey('user.id'))
    ...
    def __repr__(self):
        return 'Cleared on: {} | Lockout Desc: {}'.format(self.date, self.lockout.lockout_description)
